...
@mcp_for_unity_resource(
    ...
    description="Lists Unity instances discoverable by the selected transport, not all OS processes. Empty discovery does not prove the Editor is closed. Status is routing metadata, not readiness.\n\nURI: mcpforunity://instances"
)
